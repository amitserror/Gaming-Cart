...
<meta name="description" content="E-games store | amit.pramanik@live.co.uk">
...
<link href="<c:url value="/resources/css/zerogrid.css"/>"
	rel="stylesheet">
<link href="<c:url value="/resources/css/style.css"/>" rel="stylesheet">
<link href="<c:url value="/resources/css/responsiveslides.css"/>"
	rel="stylesheet">
...
<script src="<c:url value="/resources/js/jquery183.min.js"/>">
		...
		<div class="wrap-header zerogrid">
			<div class="row">
				...
				<a href="Index" class="logo">
					...
					<h2>
						<a href="Index"><span>E-</span>Games<span>S</span>tore</a>
					</h2> <%-- <img alt="" src="<c:url value="/resources/images/sonic.jpg" />"></img> --%>
			...
			<c:if test="${!empty selectedProduct.name}">
				...
				<tr>
					...
					<td><c:if
							...
							<a class="btn btn-xl" href="<c:url value='myCart' />">Open
								Cart</a>


							<a class="btn btn-xl"
								href="<c:url value='addToCart/${selectedProduct.id}' />">Add
								to Cart</a>


							<a class="btn btn-xl"
								href="<c:url value='Buy/${selectedProduct.name}' />">Buy</a>
						</c:if></td>
					<br>
					<br>
					<br>
	...
	<div class="slider">
		...
		<div class="callbacks_container">
			<ul class="rslides" id="slider">
				<li><img alt=""
					src="<c:url value="/resources/images/slideshow-image1.jpg" />"></img>
				...
				<li><img alt=""
					src="<c:url value="/resources/images/slideshow-image2.jpg" />"></img>
				...
				<li><img alt=""
					src="<c:url value="/resources/images/slideshow-image3.jpg" />"></img>
 ...
 -->
		...
		<div id="main-content">
								...
								<div class="item t-center">
									<div class="item-container">
										<a href="Pcgaming">
											...
											src="<c:url value="/resources/images/mafia.jpg" />"></img>
										</a>
									</div>
									<div class="item-info">
								...
								<div class="item t-center">
									<div class="item-container">
										<a href="play4">
											...
											src="<c:url value="/resources/images/play4.jpg" />"></img>
								...
								<div class="item t-center">
									<div class="item-container">
										<a href="xbox1">
											...
											src="<c:url value="/resources/images/xbox12.jpg" />"></img>
								...
								<div class="item t-center">
									<div class="item-container">
										<a href="xbox360">
											...
											src="<c:url value="/resources/images/xbox360.jpg" />"></img>
								...
								<div class="item t-center">
									<div class="item-container">
										<a href="play3">
											...
											src="<c:url value="/resources/images/play3.jpg" />"></img>
								...
								<div class="item t-center">
									<div class="item-container">
										<a href="psp">
											...
											src="<c:url value="/resources/images/psp.jpg" />"></img>
										</a>
									</div>
									<div class="item-info">
			...
			<div class="wrap-box t-center"
				...
				<div class="zerogrid">
					...
					<p>It is a Website designed for special edition games for those
						who love to play and crazy about games.</p>
				</div>
			</div>
			<div class="wrap-box">
				<!--Start Box-->
									...
									<div class="item">
										<div class="col-1-3">
											<div class="item-container">
												...
												<img alt=""
													src="<c:url value="/resources/images/darksouls.jpg" />"></img>
										...
										<div class="col-2-3">
											<div class="wrap-col">
												<div class="item-info">
													...
													<p>Dark Souls III As fires fade and the world falls
														into ruin.</p>
												</div>
											</div>
										</div>
									...
									<div class="item">
										<div class="col-1-3">
											<div class="item-container">
												...
												<img alt=""
													src="<c:url value="/resources/images/rocket.jpg" />"></img>
										...
										<div class="col-2-3">
											<div class="wrap-col">
												<div class="item-info">
													...
													<p>Take control of your own high-flying, hard-hitting,
														rocket-powered Battle-Car in the critically-acclaimed,
														futuristic Sports-Action hit</p>
												</div>
											</div>
										</div>
										<div class="clear"></div>
									...
									<div class="item">
										<div class="col-1-3">
											<div class="item-container">
												...
												<img alt=""
													src="<c:url value="/resources/images/battle.jpg" />"></img>
										...
										<div class="col-2-3">
											<div class="wrap-col">
												<div class="item-info">
													...
													<p>Battleborn is a next-gen hero-shooter brought to you
														by the creators of the award-winning and best-selling
														Borderlands franchise.</p>
												</div>
											</div>
										</div>
										<div class="clear"></div>
							...
							<div class="wrap-col">
								...
								<div class="widget">
									...
									<div class="wid-content">
										<p>It is still "Day 1" and we continue to relentlessly
											focus on using our investments in technology and innovation
											to transform the lives of our customers and all our partners.
											We strive to transform the way India shops and the way India
											sells.</p>
	...
	<div class="zerogrid">
		<div class="wrap-footer">
			<div class="row">
				<h3>Contact</h3>
				<span>Phone / +91 9749274549 </span></br> <span>Email /
					amit.pramanik@live.co.uk </span></br>
